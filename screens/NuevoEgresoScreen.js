...
export default function NuevoEgresoScren({ navigation }) {
  ...
  const onConfirmar = () => navigation.navigate("Egresos");
  const onCancelar = () => navigation.navigate("Egresos");
  ...
  return ( 
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text size={16} style={styles.signInText}>Medio de pago</Text>
        <View>
          <DropDownPicker
              items={[
                  {label: 'Contado', value: 'uk', icon: () => <Icon name="flag" size={18} color="#900" />},
                  {label: 'Tarjeta de débito', value: 'uk', icon: () => <Icon name="flag" size={18} color="#900" />},
                  {label: 'Tarjeta de crédito', value: 'uk', icon: () => <Icon name="flag" size={18} color="#900" />},
                  {label: 'Transferencia', value: 'uk', icon: () => <Icon name="flag" size={18} color="#900" />},
                  {label: 'Débito automático', value: 'france', icon: () => <Icon name="flag" size={18} color="#900" />}
              ]}
        ...
        <Text size={16} style={styles.signInText}>Tipo de Egreso</Text>
        <View>
          <DropDownPicker
                items={[
                    {label: 'Periódico', value: 'uk', icon: () => <Icon name="flag" size={18} color="#900" />},
                    {label: 'Extraordinario', value: 'france', icon: () => <Icon name="flag" size={18} color="#900" />}
                ]}
                defaultValue={tipoIngreso}
                containerStyle={{height: 40}}
                style={{backgroundColor: '#fafafa'}}
